...
//</PerfectScrollbar>
    return (
        <div className='divfilasexternoestructura'>
            <div className='divtituloestructura'>
                <div className='divparrafotituloestructura'>
                    <p className='parrafotituloestructura'>
                        Estructura 
                    </p>
                </div>
                <div className='iconoestructura'>
                <input
                      name="isGoing"
                      type="checkbox"
                      checked={sworando}
            ...
            <Scrollbars style={{ width: '100%', height: '100%'}} >
                {lista.length > 0 ? (
                    lista.map((fila, index) => (
                        <div  
                        className='divestructuracard'
                        onClick={() => props.iramyroom()}   

                    >
                        <div  
                            className='divestructuracardarriba'
                        >
                        ...
                        <div  
                            className='divestructuracardabajo'
                        >
            ...
            <div className='divexternoiconosestructura'>
                <div className='divinternoiconosestructura'>
                    <div className='iconoestructura'>
                        <IconButton  
                            color="inherit" 
                            aria-label="chat" 
